...
# д
'''
Перемещение выражения 2 ** X за пределы цикла не приведет к  улучшению производительности, т.к. это простой расчет.В сравнении, если бы расчет был более ёмким или долгим, было бы
правильнее вычислить его одноразово раз перед циклом и сохранить результат в переменной.
'''
# е
'''
